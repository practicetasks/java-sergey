...
public class FinanceApp {
    ...
    private static void findMaxExpense(double[] expenses) {
        double maxExpense = 0;
    ...
    private static void printAllExpenses(double[] expenses) {
        for (int i = 0; i < expenses.length; i++) {
            System.out.println("День " + (i + 1) + ". Потрачено " + expenses[i] + " тенге");
        }
    }

    private static void saveExpense(Scanner scanner, double moneyBeforeSalary, double[] expenses) {
    ...
    private static void getAdvice(double moneyBeforeSalary, int daysBeforeSalary) {
